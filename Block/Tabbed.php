...
class Tabbed extends Html
{
    ...
    public function __construct(Template\Context $context, \HawkSearch\Proxy\Helper\Data $helper, \HawkSearch\Proxy\Model\BannerFactory $bannerFactory, array $data = [])
    {
